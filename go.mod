...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.18.1-rc.0
...
replace k8s.io/code-generator => k8s.io/code-generator v0.18.2-rc.0

replace k8s.io/component-base => k8s.io/component-base v0.18.0

replace k8s.io/component-helpers => k8s.io/component-helpers v0.18.0

replace k8s.io/controller-manager => k8s.io/controller-manager v0.18.0

replace k8s.io/cri-api => k8s.io/cri-api v0.18.2-rc.0
...
replace k8s.io/mount-utils => k8s.io/mount-utils v0.18.1-rc.0
