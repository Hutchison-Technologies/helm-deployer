...
func TestRead(t *testing.T) {
	_, err := Open("../../testdata/settings.yaml")
	if err != nil {
...
func TestGet(t *testing.T) {
	...
	settings, err := Open("../../testdata/settings.yaml")
	...
	if val1 != test1 {
		t.Errorf("Got %v expecting %v.", val1, test1)
	}
	...
	if val3[2] != test3 {
		t.Errorf("Got %v expecting %v.", val3[2], test3)
	}
	...
	if test5 != val5 {
		t.Errorf("Got %v expecting %v.", test5, val5)
	}
	...
	if test6 != val6 {
		t.Errorf("Got %v expecting %v.", test6, val6)
	}
	...
	if test7 != val7 {
		t.Errorf("Got %v expecting %v.", test7, val7)
	}
	...
	if test8 != val8 {
		t.Errorf("Got %v expecting %v.", test8, val8)
	}
...
func TestWrite(t *testing.T) {
	...
	err := settings.Write("../../testdata/settings2.yaml")
